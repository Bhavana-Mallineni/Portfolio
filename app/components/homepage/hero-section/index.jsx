...
function HeroSection() {
	return (
		<section className="relative flex flex-col items-center justify-between py-4 lg:py-12">
			...
			<div className="grid grid-cols-1 items-start lg:grid-cols-2 lg:gap-1 gap-y-8">
					...
					<div className="overflow-hidden border-t-[2px] border-indigo-900 px-4 lg:px-8 py-4 lg:py-8">
						<code className="font-mono text-xs md:text-sm lg:text-sm">
							...
							<div>
								...
								<span className="text-gray-400">{`'`}</span>
								<span className="text-amber-300">Bhavana Mallineni</span>
								<span className="text-gray-400">{`',`}</span>
							</div>
							<div>
								<span className="ml-4 lg:ml-8 mr-2 text-white">motto:</span>
								<span className="text-gray-400">{`'`}</span>
								<span className="text-green-300">Code. </span>
								<span className="text-pink-400">Learn. </span>
								<span className="text-blue-300">Innovate. </span>
								<span className="text-gray-400">{`',`}</span>
							</div>
							...
							<div>
								<span className="ml-4 lg:ml-8 mr-2 text-white">traits:</span>
								<span className="text-gray-400">{" {"}</span>
							</div>
							<div>
								<span className="ml-12 lg:ml-15 text-cyan-400">dedicated: </span>
								<span className="text-purple-400">true</span>
								<span className="text-amber-300">,</span>
							</div>
							<div>
								<span className="ml-12 lg:ml-15 text-cyan-400">adaptiveLearner: </span>
								<span className=" text-purple-400">true</span>
								<span className="text-amber-300">,</span>
							</div>
							<div>
								<span className="ml-12 lg:ml-15 text-cyan-400">problemSolver: </span>
								<span className="text-purple-400">true</span>
							...
							<div>
								<span className="ml-4 lg:ml-8 mr-2 text-white">funFacts:</span>
								<span className="text-gray-400">{"{"}</span>
							</div>
							<div>
							...
							<div>
								<span className="ml-4 lg:ml-8 mr-1 text-pink-300">codingPhilosophy:</span>
